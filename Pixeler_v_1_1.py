...
class PXL_OT_create_pixels(bpy.types.Operator):
    bl_idname = 'object.pxl_ot_create_pixels'
    bl_label = "Pixeler"
    bl_options = {'REGISTER'}
            ...
            for index in range(0, w):
                ...
                if tfac[colar - 1] > 0:
                    ...
                    if mat is None:
                        ...
                        bpy.data.materials[matname].diffuse_color = (r, g, b, 1)
...
class PXL_PT_pixeler_panel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.operator("object.pxl_ot_create_pixels", text="Pixeler", icon="PLAY")

classes = ( PXL_OT_create_pixels, PXL_PT_pixeler_panel )
